...
def sp_stats(end_event):
  ...
  param_keys = [
    ...
    # Honda Nidec dynamic longitudinal tuning: the learned state, so convergence
    # is visible without pulling a route and grepping the `hondadyn` carlog lines.
    # These are the PERSISTED estimates, which is what actually carries between
